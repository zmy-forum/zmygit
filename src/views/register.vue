    ...
    <div>
        ...
        <div id="wrapper">
            <div id="middle" class="container">
                <div class="title">欢迎成为我们的新用户</div>
                <div class="account-form">
                    ...
                    <div class="account-form-group button-row">
                        ...
                        <div href="javascript:void(0)" class="account-form-btn js-btn-login" @click="submit">注册</div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods:{
         ...
         submit (){
                ...
                // http://www.coldairance.com/tuitui/
                var data = {"username":userName, "password":password }
                axios.post('http://www.coldairance.com/tuitui/register',data,{headers:{'Content-Type':'application/json'}})
                    .then(res => {
                        Dialog({message: '注册成功，即将前往登录界面,登录uid为:'+res.data.data.uid, })
                        .then(() => {
